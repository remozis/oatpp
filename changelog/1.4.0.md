...
- [Fix client connections](#fix-client-connections)
...
When we create an asynchronous connection, we have to verify the connection succeeded before proceeding to normal workflow
